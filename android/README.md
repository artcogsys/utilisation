...
1. [TF Classify](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/utilisation/android/src/org/tensorflow/demo/ClassifierActivity.java):
        Uses the [Google Inception](https://arxiv.org/abs/1409.4842)
        model to classify camera frames in real-time, displaying the top results
        in an overlay on the camera image.
2. [TF Detect](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/utilisation/android/src/org/tensorflow/demo/DetectorActivity.java):
        ...
        in real-time.
3. [TF Stylize](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/utilisation/android/src/org/tensorflow/demo/StylizeActivity.java):
...
4.  [TF
    Speech](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/utilisation/android/src/org/tensorflow/demo/SpeechActivity.java):
...
do
  ...
  unzip /tmp/${MODEL_ZIP} -d tensorflow/utilisation/android/assets/
done
```
...
```bash
bazel build -c opt //tensorflow/utilisation/android:tensorflow_demo
```
...
```bash
adb install -r bazel-bin/tensorflow/utilisation/android/tensorflow_demo.apk
```
...
At this point you can add the tensorflow/utilisation/android directory as a new
