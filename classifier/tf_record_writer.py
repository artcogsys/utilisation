# Taken from
# https://github.com/pudae/tensorflow-pspnet/blob/master/datasets/download_and_convert_ade20k.py
...
def _to_tfexample(image_data, image_format, label_data, label_format, height, width, image_id):
                ...
                with tf.python_io.TFRecordWriter(record_filename) as tfrecord_writer:
                    ...
                    for i in range(start_ndx, end_ndx):
                        ...
                        example = _to_tfexample(
                            image_data, 'jpg', label_data, 'png', height, width, image_id)
                        image_id += 1
