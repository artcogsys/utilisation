...
#include "tensorflow/utilisation/android/jni/rgb2yuv.h"
#include "tensorflow/utilisation/android/jni/yuv2rgb.h"

#define IMAGEUTILS_METHOD(METHOD_NAME) \
  Java_net_ccnlab_eyecontact_env_ImageUtils_##METHOD_NAME  // NOLINT
